...
const Header = () => {
  ...
  return (
    <div className="w-full relative sticky z-50  top-0 p-4 ">
      <header className="bg-white" id="header">
        <div className="mx-auto flex h-16 max-w-screen-2xl items-center gap-8 px-4 sm:px-6 lg:px-8 rounded-full bg-indigo-50 rounded-full bg-indigo-50">
